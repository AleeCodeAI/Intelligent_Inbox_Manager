...
class NonBusinessFlowObservability:
    """
    Langfuse observability for NonBusinessFlow.
    ...
    # ------------------------------------------------------------------
    # 1. Trace — one per email, opened at the start of NonBusinessFlow.run()
    # ------------------------------------------------------------------
        ...
        self._ingest([
            {
                ...
                "body": {
                    "id": self._trace_id,
                    "name": "nonbusiness-flow-email",
                    "sessionId": thread_id,
                    "input": body,
                    "tags": ["nonbusiness-flow", "email"],
                    "metadata": {
                        "gmail_id": gmail_id,
        ...
        self._ingest([
            {
                ...
                "body": {
                    ...
                    "metadata": {
                        ...
                        "nonbusiness_type": result.nonbusiness_type,  # was: result.priority_type
    ...
    def finish_trace(self, result: NonBusinessResult) -> None:
    ...
    def score_success(self, comment: str = "Non-business classified successfully.") -> None:
        self._score("nonbusiness-flow-success", 1, comment)

    def score_failure(self, reason: str) -> None:
        self._score("nonbusiness-flow-failure", 0, reason)
