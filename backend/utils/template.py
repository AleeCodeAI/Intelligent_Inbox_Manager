        ...
        <table role="presentation" style="width:100%;max-width:580px;margin:0 auto;border-collapse:collapse;background:#ffffff;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <p style="margin:0 0 22px 0;font-family:'Lora',Georgia,serif;font-size:17px;line-height:1.6;color:#1a2a3a;font-style:italic;">
                Dear {recipient_name},
              </p>
...
_PARAGRAPH = (
    '<p style="margin:0 0 18px 0;font-family:\'DM Sans\',Arial,sans-serif;'
    'font-size:15px;line-height:1.75;color:#2c3e50;">'
    "{text}"
    "</p>"
)
