...
def send_to_n8n(data):
    ...
    """
    url = "http://localhost:5678/webhook/27dd1715-2450-4a71-886d-8f1070592870"
    ...
    try:
        ...
        # --- CLEAN UP n8n RESPONSE ---
        # n8n sometimes returns: {'object Object': {'data': [ {...} ]}}
        # Extract the first item if needed
        if isinstance(result, dict):
            ...
            if "status" in result:
                return {"status": result.get("status"), "emailId": result.get("emailId")}
